...
<?php foreach($attributes->onlyProps(['style' => session('flash.bannerStyle', 'success'), 'message' => session('flash.banner')]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php /**PATH F:\xampp\htdocs\ProyectoIncidencias\vendor\laravel\jetstream\src/../resources/views/components/banner.blade.php ENDPATH**/ ?>